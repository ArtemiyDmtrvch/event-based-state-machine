 ...
 * starting point for a new [Action]. Event occurs in [FlowPerformer] and is passed to [Flow]. Create in your Event
 * fields with data that you want to transfer from [FlowPerformer] to [Flow].
 *
